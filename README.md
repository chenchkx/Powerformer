...
# The following picture is the ablation study on the China 300-bus system. Due to time limitation, we will provide the ablation study on the large-scale European 9241-bus systems in this repository later.
